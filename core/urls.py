...
urlpatterns = [
    ...
    path('api/orders/<int:pk>/', UpdateOrderView.as_view(), name='update-order'),
    path('api/partner/income/', PartnerIncomeView.as_view(), name='get_income'),
    ...
    path('api/users/orders/', OrderView.as_view(), name='user-order'),
