    ...
    def ready(self):
        ...
        QUESTION_ANSWERS_MAP = {
                ...
                "football-shoes": {
                    ...
                    "How do you prefer your shoes to fit?": [
                        ("perfect_fit", "The perfect soccer cleat fit based on my 3D scan"),
                        ("roomy", "Rather roomy, as I prefer more freedom of movement")
                    ]
                },
                ...
                "climbing-shoes": {
                    ...
                    "How do you prefer your shoes to fit?": [
                        ("perfect_fit", "The recommended climbing shoe fit based on my 3D scan"),
                        ("roomy", "Rather roomy, for more freedom of movement and higher all-day comfort")
                    ]
                },
                ...
                "tennis-shoes": {
                    ...
                    "How do you prefer your shoes to fit?": [
                        ("perfect_fit", "The perfect tennis shoe fit based on my 3D scan"),
                        ("snug", "Rather snug, as I like my shoes to fit tightly on my foot"),
                        ("roomy", "Rather roomy, as I prefer more freedom of movement")
                    ]
                },
                ...
                "basketball-shoes": {
                    ...
                    "How do you prefer your shoes to fit?": [
                        ("perfect_fit", "The perfect basketball shoe fit based on my 3D scan"),
                        ("snug", "Rather snug, as I like my shoes to fit tightly on my foot"),
                        ("roomy", "Rather roomy, as I prefer more freedom of movement")
                    ]
                },
                ...
                "golf-shoes": {
                    ...
                    "How do you prefer your shoes to fit?": [
                        ("perfect_fit", "The perfect recommended golf shoe fit based on my 3D scan"),
                        ("snug", "Rather snug, as I like my shoes to fit tightly on my foot"),
                        ("roomy", "Rather roomy, as I prefer more freedom of movement")
                    ]
                },
                ...
                "casual-sneaker": {
                    ...
                    "How do you prefer your shoes to fit?": [
                        ("perfect_fit", "The perfect recommended fit based on my 3D scan"),
                        ("snug", "Rather snug, as I like my shoes to fit tightly on my foot"),
                        ("roomy", "Rather roomy, as I prefer more freedom of movement")
                    ],
        ...
        try:
            for sub_cat, questions in QUESTION_ANSWERS_MAP.items():
                for q_label, ans_list in questions.items():
                    question_key = f"{q_label.lower().replace(' ', '_')[:240]}"
            ...
            # Database not ready yet (e.g., migrations not applied)
            pass
